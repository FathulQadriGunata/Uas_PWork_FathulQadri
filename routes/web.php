...
use App\Http\Controllers\NilaiFathulController;
...
Route::group(['middleware' => 'auth'], function (){
    ...
    Route::get('nilai', [NilaiFathulController::class, 'index'])->name('nilai.index');
    Route::get('cetak_nilai', [NilaiFathulController::class, 'cetak_nilai'])->name('cetak_nilai');
